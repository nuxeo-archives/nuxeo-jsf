...
final class StampState implements Externalizable {
     ...
     * the new currency. This method recurses for the children and facets of
     * the stamp.
     *
    ...
    public static Object saveStampState(FacesContext context, UIComponent stamp) {
        ...
        // because base components use shallow copies in their saveState
        // method,
        ...
        if (stamp instanceof ChainSelect) {
            ...
            innerSelfState[0] = stamp.saveState(context);
            // TODO: migrate to JSF2/CDI if needed
    ...
    public static void restoreStampState(FacesContext context,
        ...
        // NXP-1508: restoring specific values for components that do not
        // follow
