...
public class SelectDataModelRowImpl implements SelectDataModelRow {
    ...
    public void selectionChanged(ValueChangeEvent event) {
        ...
        // XXX AT: no need to change the selected attribute since it is
        // supposed
        ...
        if (newValue instanceof Boolean && oldValue instanceof Boolean
            ...
            for (SelectDataModelListener listener : model.getSelectModelListeners()) {

                // FIXME: migrate to CDI
                // Object seamComponent =
                // SeamComponentCallHelper.getSeamComponentByRef(listener);
                Object seamComponent = null;
